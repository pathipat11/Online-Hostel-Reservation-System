...
<div class="main">
<div class="container">
<div class="h4 text-center alert alert-secondary mb-3 mt-3" role="alert">ข้อมูลการรายรับ (การสั่งอาหาร)</div>
<table class="table">
<tr>
...
$sql1 = "select * from payment_food";
$result1 = mysqli_query($link,$sql1);
$sql2 = "select SUM(food_price) AS sumprice from payment_food";
